...
/* ── INDEX — video inspection ── */
    ...
    'products.dual.buy.title': { en:'Source Stock From MICA', fr:'Approvisionnez-vous chez MICA', zh:'从 MICA 采购货源', ar:'احصل على المخزون من MICA', de:'Ware von MICA beziehen' },
    'products.dual.buy.desc': { en:'Buyers in Hong Kong, the UAE, and Southeast Asia — send us your target model, grade, and volume.', fr:'Acheteurs à Hong Kong, aux Émirats et en Asie du Sud-Est — indiquez-nous le modèle, le grade et le volume souhaités.', zh:'香港、阿联酋及东南亚的买家——把您要的型号、成色和数量发给我们。', ar:'المشترون في هونغ كونغ والإمارات وجنوب شرق آسيا — أرسلوا لنا الطراز والفئة والكمية المطلوبة.', de:'Käufer in Hongkong, den Emiraten und Südostasien — nennen Sie uns Zielmodell, Grade und Menge.' },
    'products.dual.buy.li1': { en:'Graded stock with IMEI verification & grading report', fr:'Stock classé avec vérification IMEI et rapport de classement', zh:'分级货品，附 IMEI 核验与分级报告', ar:'مخزون مصنّف مع التحقق من IMEI وتقرير التصنيف', de:'Geprüfte Ware mit IMEI-Verifizierung und Grading-Bericht' },
    'products.dual.buy.li2': { en:'FCA Hong Kong · USD settlement (Airwallex / PingPong)', fr:'FCA Hong Kong · règlement en USD (Airwallex / PingPong)', zh:'FCA 香港 · 美元结算（Airwallex / PingPong）', ar:'FCA هونغ كونغ · تسوية بالدولار (Airwallex / PingPong)', de:'FCA Hongkong · USD-Abwicklung (Airwallex / PingPong)' },
    'products.dual.buy.li3': { en:'IATA-compliant lithium battery packaging', fr:'Emballage de batteries au lithium conforme IATA', zh:'符合 IATA 的锂电池运输包装', ar:'تغليف بطاريات ليثيوم متوافق مع IATA', de:'IATA-konforme Lithium-Akku-Verpackung' },
    'products.dual.buy.btn': { en:'Request a Quote', fr:'Demander un devis', zh:'提交询价', ar:'اطلب عرض سعر', de:'Angebot anfordern' },
    'products.dual.sell.eyebrow': { en:'// You Supply', fr:'// Vous fournissez', zh:'// 您供货', ar:'// أنت تورّد', de:'// Sie liefern' },
    'products.dual.sell.title': { en:'Sell Bulk Stock to MICA', fr:'Vendez du stock en gros à MICA', zh:'向 MICA 批量出货', ar:'بِع مخزونًا بالجملة إلى MICA', de:'Großmengen an MICA verkaufen' },
    'products.dual.sell.desc': { en:'Have volume to move? We buy carrier-clean lots from B-Stock sellers, trade-in channels, and repair shops.', fr:'Du volume à écouler ? Nous achetons des lots carrier-clean auprès de vendeurs B-Stock, de canaux de reprise et d\'ateliers de réparation.', zh:'有量要出？我们从 B-Stock 卖家、以旧换新渠道和维修商收购无锁干净批次。', ar:'لديك كميات للتصريف؟ نشتري دفعات نظيفة من بائعي B-Stock وقنوات الاستبدال ومحلات الإصلاح.', de:'Mengen abzugeben? Wir kaufen carrier-clean Lots von B-Stock-Verkäufern, Trade-in-Kanälen und Reparaturwerkstätten.' },
    'products.dual.sell.li1': { en:'B-Stock lots, carrier trade-in volume, repair stock', fr:'Lots B-Stock, volumes de reprise opérateur, stock de réparation', zh:'B-Stock 批次、运营商以旧换新量、维修库存', ar:'دفعات B-Stock، كميات استبدال المشغّلين، مخزون الإصلاح', de:'B-Stock-Lots, Carrier-Trade-in-Mengen, Reparaturbestände' },
    'products.dual.sell.li2': { en:'North American pickup · we handle export logistics', fr:'Enlèvement en Amérique du Nord · nous gérons la logistique d\'exportation', zh:'北美提货 · 出口物流我们负责', ar:'الاستلام في أمريكا الشمالية · نتولّى لوجستيات التصدير', de:'Abholung in Nordamerika · wir übernehmen die Export-Logistik' },
    'products.dual.sell.li3': { en:'Fast USD payout · clear grading expectations upfront', fr:'Paiement rapide en USD · attentes de classement claires dès le départ', zh:'美元快速结款 · 分级标准事先讲清', ar:'دفع سريع بالدولار · توقعات تصنيف واضحة مسبقًا', de:'Schnelle USD-Auszahlung · klare Grading-Erwartungen vorab' },
    'products.dual.sell.btn': { en:'Offer Us Stock', fr:'Proposez votre stock', zh:'向我们报货', ar:'اعرض مخزونك علينا', de:'Ware anbieten' },
